...
<script>
    function refreshTable() {
        $.ajax({
            url: "/friends/getFriendsTable.jsp", // 테이블 데이터만 반환하는 JSP
            type: "get",
...
$(function() {
    ...
    $("#delete").on("click", function() {
        ...
        if (selectedIds) {
            ...
            $.ajax({
                url : "/friends/deleteFriendsTable.jsp",
                type : "post",
                data : params,
                dataType : "json",
                success : function(result) {
    ...
    $("#update").on("click", function() {
        ...
        $.ajax({
            url : "/friends/updateFriendsTable.jsp",
            type : "post",
            data : params,
            dataType : "json",
            success : function(result) {
    ...
    $("#insert").on("click", function() {
        ...
        $.ajax({
            url: "/friends/insertFriendsTable.jsp",
            type: "post",
            data: params,
            dataType: "json",
            success: function(result) {
